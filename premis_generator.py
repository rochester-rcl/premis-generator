...
for row in csv_reader:
    ...
    event_1_type = row[5]
    event_1_datetime = row[6]
    event_1_details = row[7]
    event_1_agent = row[8]
    event_2_uuid = uuid.uuid4()
    event_2_type = row[9]
    event_2_datetime = row[10]
    event_2_details = row[11]
    event_2_agent = row[12]
...
</premis:premis>'''.format(preservica_uuid=preservica_uuid, rights_uuid=rights_uuid, rights_basis=rights_basis, rights_status=rights_status, rights_jurisdiction=rights_jurisdiction, rights_date=rights_date, event_1_uuid=event_1_uuid, event_1_type=event_1_type, event_1_datetime=event_1_datetime, event_1_details=event_1_details, event_1_agent=event_1_agent, event_2_uuid=event_2_uuid, event_2_type=event_2_type, event_2_datetime=event_2_datetime, event_2_details=event_2_details, event_2_agent=event_2_agent)
